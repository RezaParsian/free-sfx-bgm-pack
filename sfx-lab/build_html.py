...
CATS = [
    ...
    ("تایپ و ترمینال", "#22D3EE", "⌨️", [
        ("type_key_single", "تک‌کلید مکانیکی", "همگام‌سازی با کلیدهای دیده‌شده روی تصویر", "روی فریم فشردن کلید", "−۱۲ dB"),
        ("type_burst_mech", "تایپ مکانیکی کلیکی (۲.۸s)", "تایپ کد در ادیتور/ترمینال وقتی روی تصویر دیده می‌شود",
         "با Rate Stretch با سرعت تایپ واقعی هماهنگ کن", "−۱۶ dB"),
        ("type_burst_soft", "تایپ نرم و بی‌صداتر (۳.۲s)", "تایپ <b>زیر نریشن</b>، جلسه‌های طولانی کدنویسی", "Loop یا زنجیره‌ای پشت‌سرهم", "−۱۸ dB"),
        ("type_key_roll", "رگبار ۷ کلید", "تایپ سریع دستور بلند، one-liner ها", "روی شروع تایپ دستور", "−۱۳ dB"),
        ("type_enter", "کلید Enter با تاک عمیق", "<b>لحظه‌ی اجرای دستور در ترمینال</b>", "دقیقاً روی فریم فشردن Enter", "−۱۰ dB"),
        ("type_backspace", "کلید Backspace", "حذف/اصلاح، «اشتباه تایپ کردم»", "روی فریم حذف", "−۱۲ dB"),
        ("terminal_bell", "زنگ کلاسیک ترمینال (\\a)", "پایان موفق job، خروجی آماده شد", "روی فریم ظاهرشدن خروجی", "−۱۲ dB"),
        ("prompt_tick", "تیک ظهور prompt", "آمدن خط prompt جدید، آماده‌بودن shell", "روی فریم ظهور <code>$</code> یا <code>#</code>", "−۱۶ dB"),
        ("scroll_ratchet", "اسکرول رچتی", "اسکرول لاگ، man page، خروجی طولانی دستور", "هم‌زمان با حرکت اسکرول تصویر", "−۱۴ dB"),
    ]),
...
BGMS = [
    ...
    ("bgm_terminal_flow", 92, "مینیمال تاریک-خنثی: پالس ساب + پلاک پنتاتونیک + اکو",
     "کدنویسی زنده، تیم‌لپس تایپ، جلسه‌های ترمینال لینوکس", "−۲۲ dB", "main"),
...
A("<h3>الگوی ویدیوی آموزش برنامه‌نویسی / لینوکس</h3>")
A("<table><tr><th>لحظه</th><th>چه اتفاقی</th><th>صدا</th></tr>")
for a, b, c in [("0:00 – 0:05", "هوک: نمایش خروجی نهایی دستور", "boom_cinematic + bgm_hook_loop_8s"),
                ("0:05 – 0:15", "اینترو", "logo_sting"),
                ("توضیح مفهوم", "نریشن روی اسلاید/دیاگرام", "bgm_ambient_underscore یا bgm_screen_bed"),
                ("تایپ کد (دیده می‌شود)", "B-roll تایپ", "type_burst_mech همگام + bgm_terminal_flow"),
                ("تایپ زیر صدای خودت", "نریشن هم‌زمان با تایپ", "type_burst_soft روی −۱۸ dB"),
                ("اجرای دستور", "فریم Enter", "type_enter + prompt_tick بعد از ظهور خروجی"),
                ("خطای دستور", "خروجی قرمز", "error_buzz + type_backspace"),
                ("موفقیت job", "خروجی سبز / exit code 0", "terminal_bell + success_chime"),
                ("اسکرول لاگ / man", "حرکت اسکرول", "scroll_ratchet"),
                ("پایان", "CTA", "logo_sting")]:
    A(f"<tr><td class='dur' style='white-space:nowrap'>{a}</td><td>{b}</td><td><code>{c}</code></td></tr>")
A("</table>")
A("<div class='tip'><b>قانون تایپ زیر نریشن:</b> وقتی خودت داری حرف می‌زنی، هرگز <code>type_burst_mech</code> (کلیکی) نگذار — "
  "فرکانس کلیک‌ها با صدای انسان می‌جنگد. برای زیر نریشن فقط <code>type_burst_soft</code> روی −۱۸ dB.</div>")
